<template>
  <div class="navbar">
    ...
    <div class="right-menu">
      ...
      <el-dropdown class="avatar-container right-menu-item hover-effect" trigger="click">
        ...
        <el-dropdown-menu slot="dropdown">
          ...
          <el-dropdown-item>
            <span style="display:block;" @click="showChangePasswordDialog(userId)">修改密码</span>
          </el-dropdown-item>
    ...
    <password-dialog ref="changePassword" />
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    showChangePasswordDialog(userId) {
      this.$refs.changePassword.showDialog(userId)
    }
  }
}
</script>
